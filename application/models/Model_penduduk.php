...
class Model_penduduk extends MY_Model {
	...
	private $field_search 	= ['nik', 'nama', 'jenis_kelamin', 'alamat', 'agama', 'no_kk'];
	...
	public function count_all($q = null, $field = null)
	{
        ...
        if (empty($field)) {
	        foreach ($this->field_search as $field) {
	            if ($iterasi == 1) {
	                $where .= "penduduk.".$field . " LIKE '%" . $q . "%' and penduduk.kd_wilayah='$kd_wilayah' ";
	            } else {
	                $where .= "OR " . "penduduk.".$field . " LIKE '%" . $q . "%' and penduduk.kd_wilayah='$kd_wilayah'";
	            }
	            $iterasi++;
	        }
