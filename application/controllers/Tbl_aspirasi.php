...
class Tbl_aspirasi extends Admin	
{
	...
	*/
	public function index($offset = 0)
	{
		...
		$this->template->title('Tbl Aspirasi List');
	...
	*/
	public function add()
	{
		...
		$this->template->title('Tbl Aspirasi New');
	...
	*/
	...
	//	$this->form_validation->set_rules('nik', 'Nik', 'trim|required');
		...
		if ($this->form_validation->run()) {
		    ...
		    $kode_wilayah = get_user_data('kd_wilayah');
		    $time = strtotime('now');
            $nomor_aduan = $kode_wilayah.$time;
            
			$save_data = [
				'kd_wilayah' => $this->input->post('kd_wilayah'),
				//'nomor_aduan' => substr("nomor_aduan", 6).,
	...
	*/
	public function edit($id)
	{
		...
		$this->template->title('Tbl Aspirasi Update');
	...
	*/
	public function view($id)
	{
		...
		$this->template->title('Tbl Aspirasi Detail');
