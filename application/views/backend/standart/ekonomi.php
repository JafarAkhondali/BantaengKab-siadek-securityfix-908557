     ...
     <div class="row">
      <div class="col-md-12">        
          <div class="box box-danger">
            ...
            <div class="tab-content">
                <div class="tab-pane" id="bumdes-jenkel">
                <div id='bumdes_jk'></div>
                </div>
                <div class="tab-pane  active" id="bumdes-jenis">
      ...
      <div class="col-md-12">        
          <div class="box box-danger">
            ...
            <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#umkm-tab" data-toggle="tab" aria-expanded="true" data-original-title="" title="">Kepemilikan</a></li>
                        <li class=""><a href="#umkm-tab1" data-toggle="tab" aria-expanded="false" data-original-title="" title="">UMKM 1 </a></li>
                    </ul>
            </div>
            <div class="tab-content">
...
<script>
        ...
        var chart = new ApexCharts(document.querySelector("#umkm_kep"), options);
        chart.render();
</script>
