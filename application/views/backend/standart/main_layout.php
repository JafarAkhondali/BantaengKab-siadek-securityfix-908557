...
<body class="sidebar-mini skin-red fixed web-body" style="font-size: 18px">
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= _ent(ucwords(clean_snake_case(get_user_data('full_name')))); ?></span><span class="caret"></span>
            </a>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Siadek <?= cclang('version') ?></b> 2.0.0
    </div>
    <strong>Copyright &copy; 2018-<?=date('Y'); ?> <a href="#"><?= get_option('site_name'); ?></a> </strong>Kabupaten Bantaeng
  </footer>
