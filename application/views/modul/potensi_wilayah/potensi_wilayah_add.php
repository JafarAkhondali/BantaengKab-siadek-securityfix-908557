                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Potensi Wilayah']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="potensi_wilayah" id="potensi_wilayah" placeholder="Potensi" value="<?= set_value('potensi_wilayah'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/potensi_wilayah/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
