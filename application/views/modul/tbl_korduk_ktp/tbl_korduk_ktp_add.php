                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Adminduk KTP']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_ktp_form_uuid" id="tbl_korduk_ktp_form_uuid" type="hidden" value="<?= set_value('tbl_korduk_ktp_form_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_ktp_form_name" id="tbl_korduk_ktp_form_name" type="hidden" value="<?= set_value('tbl_korduk_ktp_form_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_ktp_kk_uuid" id="tbl_korduk_ktp_kk_uuid" type="hidden" value="<?= set_value('tbl_korduk_ktp_kk_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_ktp_kk_name" id="tbl_korduk_ktp_kk_name" type="hidden" value="<?= set_value('tbl_korduk_ktp_kk_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_ktp_suket_hilang_uuid" id="tbl_korduk_ktp_suket_hilang_uuid" type="hidden" value="<?= set_value('tbl_korduk_ktp_suket_hilang_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_ktp_suket_hilang_name" id="tbl_korduk_ktp_suket_hilang_name" type="hidden" value="<?= set_value('tbl_korduk_ktp_suket_hilang_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/tbl_korduk_ktp/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_form = $('#tbl_korduk_ktp_form_galery').find('li').attr('qq-file-id');
            var id_kk = $('#tbl_korduk_ktp_kk_galery').find('li').attr('qq-file-id');
            var id_suket_hilang = $('#tbl_korduk_ktp_suket_hilang_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_form !== 'undefined') {
                    $('#tbl_korduk_ktp_form_galery').fineUploader('deleteFile', id_form);
                }
            if (typeof id_kk !== 'undefined') {
                    $('#tbl_korduk_ktp_kk_galery').fineUploader('deleteFile', id_kk);
                }
            if (typeof id_suket_hilang !== 'undefined') {
                    $('#tbl_korduk_ktp_suket_hilang_galery').fineUploader('deleteFile', id_suket_hilang);
                }
