              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <?php 
                    ...
                    $this->db->like('kd_wilayah', get_user_data('kd_wilayah'));
		            $kelurahan= $this->db->count_all_results(); 
                    echo $kelurahan - 1;
                 ?>
                 </span></td>
                </tr>
        ...
        <div class="col-md-8">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#desa" data-toggle="tab" aria-expanded="false" data-original-title="" title="">Desa</a></li>
