                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="sejarah" name="sejarah" rows="5" cols="50"><?= set_value('Sejarah'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                    ...
                    <!--===============================================================---->
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="dasar_hukum" name="dasar_hukum" rows="5" cols="10"><?= set_value('Dasar Hukum'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>          
