        ...
        <div class="box-body ">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header ">
              ...
              <h5 class="widget-user-desc">Edit Surat Keterangan Tidak Mampu</h5>
              <hr>
            </div>
            <?= form_open(base_url('suket_timam/edit_save/' . $this->uri->segment(3)), [
              ...
              <div class="col-sm-8">
                <select class="form-control chosen chosen-select-deselect" name="kd_wilayah" id="kd_wilayah" data-placeholder="Select Kd Wilayah" disabled>
                  ...
                  <?php foreach (db_get_all_data('wilayah') as $row) : ?>
                    <option <?= $row->kd_wilayah ==  $suket_timam->kd_wilayah ? 'selected' : ''; ?> value="<?= $row->kd_wilayah ?>"><?= $row->nama; ?></option>
                  <?php endforeach; ?>
                </select>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                <select class="form-control chosen chosen-select" name="perihal_surat" id="perihal_surat" data-placeholder="Select Perihal Surat">
                  <option value=""></option>
                  <option <?= $suket_timam->perihal_surat == "Biaya Pendidikan" ? 'selected' : ''; ?> value="Biaya Pendidikan">Biaya Pendidikan</option>
                  <option <?= $suket_timam->perihal_surat == "Biaya Pengobatan" ? 'selected' : ''; ?> value="Biaya Pengobatan">Biaya Pengobatan</option>
                  <option <?= $suket_timam->perihal_surat == "Lainnya" ? 'selected' : ''; ?> value="Lainnya">Lainnya</option>
                </select>
                <small class="info help-block">
                </small>
              </div>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-6">
                <div class="input-group date col-sm-8">
                  <input type="text" class="form-control pull-right datepicker" name="tanggal_surat" placeholder="Tanggal Surat" id="tanggal_surat" value="<?= set_value('suket_timam_tanggal_surat_name', $suket_timam->tanggal_surat); ?>">
                </div>
                <small class="info help-block">
                </small>
              </div>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                ...
                $kdwilayah = $suket_timam->kd_wilayah;
                ...
                <select class="form-control chosen chosen-select-deselect" name="nik" id="nik" data-placeholder="Select Nik">
                  ...
                  <?php foreach ($a as $row) : ?>
                    ...
                    <option <?php if ($row->nik == $suket_timam->nik) { ?>selected="selected" <?php } ?> value="<?= $row->nik ?>"><?= '[ ' . $row->nik . ' ] ' . $row->nama ?></option>
                  <?php endforeach; ?>
                </select>
                <small class="info help-block">
                </small>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                ...
                <select class="form-control chosen chosen-select-deselect" name="perangkat_id" id="perangkat_id" data-placeholder="Select Perangkat Id">
                  ...
                  <?php foreach ($a as $row) : ?>
                    <option <?php if ($row->id == $suket_timam->perangkat_id) { ?>selected="selected" <?php } ?> value="<?= $row->id ?>"><?= '[ ' . $row->jabatan . ' ] ' . $row->nama ?></option>
                  <?php endforeach; ?>
                </select>
                <small class="info help-block">
                </small>
  ...
  $(document).ready(function() {
    ...
    $('#btn_cancel').click(function() {
      swal({
        ...
        function(isConfirm) {
          if (isConfirm) {
            window.location.href = BASE_URL + 'suket_timam';
          }
        });
    ...
    $('.btn_save').click(function() {
      ...
      $.ajax({
          url: form_suket_timam.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if (res.success) {
            var id = $('#suket_timam_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
