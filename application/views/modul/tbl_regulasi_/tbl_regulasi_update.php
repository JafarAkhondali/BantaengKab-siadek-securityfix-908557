                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Regulasi</h5>
                            <hr>
                        </div>
                  ...
                  <?php endforeach; ?>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="status" id="status" data-placeholder="Select Status" >
                                    <option value=""></option>
                                    <option <?= $tbl_regulasi->status == "Ya" ? 'selected' :''; ?> value="Ya">Ya</option>
                                    <option <?= $tbl_regulasi->status == "Tidak" ? 'selected' :''; ?> value="Tidak">Tidak</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
