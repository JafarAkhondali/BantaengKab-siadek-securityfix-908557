                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Adminduk Akta Kelahiran']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kepala_keluarga" id="kepala_keluarga" placeholder="Kepala Keluarga" value="<?= set_value('kepala_keluarga'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_form_f228_uuid" id="tbl_korduk_akta_kelahiran_form_f228_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_form_f228_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_form_f228_name" id="tbl_korduk_akta_kelahiran_form_f228_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_form_f228_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_kk_uuid" id="tbl_korduk_akta_kelahiran_kk_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_kk_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_kk_name" id="tbl_korduk_akta_kelahiran_kk_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_kk_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_ktp_ayah_uuid" id="tbl_korduk_akta_kelahiran_ktp_ayah_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_ktp_ayah_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_ktp_ayah_name" id="tbl_korduk_akta_kelahiran_ktp_ayah_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_ktp_ayah_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_ktp_ibu_uuid" id="tbl_korduk_akta_kelahiran_ktp_ibu_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_ktp_ibu_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_ktp_ibu_name" id="tbl_korduk_akta_kelahiran_ktp_ibu_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_ktp_ibu_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_akta_pernikahan_uuid" id="tbl_korduk_akta_kelahiran_akta_pernikahan_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_akta_pernikahan_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_akta_pernikahan_name" id="tbl_korduk_akta_kelahiran_akta_pernikahan_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_akta_pernikahan_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_form_f201_uuid" id="tbl_korduk_akta_kelahiran_form_f201_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_form_f201_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_kelahiran_form_f201_name" id="tbl_korduk_akta_kelahiran_form_f201_name" type="hidden" value="<?= set_value('tbl_korduk_akta_kelahiran_form_f201_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  500 kb.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/tbl_korduk_akta_kelahiran/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_form_f228 = $('#tbl_korduk_akta_kelahiran_form_f228_galery').find('li').attr('qq-file-id');
            var id_kk = $('#tbl_korduk_akta_kelahiran_kk_galery').find('li').attr('qq-file-id');
            var id_ktp_ayah = $('#tbl_korduk_akta_kelahiran_ktp_ayah_galery').find('li').attr('qq-file-id');
            var id_ktp_ibu = $('#tbl_korduk_akta_kelahiran_ktp_ibu_galery').find('li').attr('qq-file-id');
            var id_akta_pernikahan = $('#tbl_korduk_akta_kelahiran_akta_pernikahan_galery').find('li').attr('qq-file-id');
            var id_form_f201 = $('#tbl_korduk_akta_kelahiran_form_f201_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            if (typeof id_form_f228 !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_form_f228_galery').fineUploader('deleteFile', id_form_f228);
                }
            if (typeof id_kk !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_kk_galery').fineUploader('deleteFile', id_kk);
                }
            if (typeof id_ktp_ayah !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_ktp_ayah_galery').fineUploader('deleteFile', id_ktp_ayah);
                }
            if (typeof id_ktp_ibu !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_ktp_ibu_galery').fineUploader('deleteFile', id_ktp_ibu);
                }
            if (typeof id_akta_pernikahan !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_akta_pernikahan_galery').fineUploader('deleteFile', id_akta_pernikahan);
                }
            if (typeof id_form_f201 !== 'undefined') {
                    $('#tbl_korduk_akta_kelahiran_form_f201_galery').fineUploader('deleteFile', id_form_f201);
                }
