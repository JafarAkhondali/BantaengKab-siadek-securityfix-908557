...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/Vaksinasi/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        <?php is_allowed('vaksinasi_add', function(){?>
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="Tambah Data  (Ctrl+a)" href="<?=  site_url('vaksinasi/add'); ?>"><i class="fa fa-plus-square-o" ></i> Tambah Data</a>
                        <?php }) ?>
                        <?php is_allowed('vaksinasi_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> XLS" href="<?= site_url('vaksinasi/export'); ?>"><i class="fa fa-file-excel-o" ></i></a>
                        <?php }) ?>
                        <?php is_allowed('vaksinasi_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> PDF" href="<?= site_url('vaksinasi/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i></a>
                        <?php }) ?>
                     </div>
                     ...
                     <h5 class="widget-user-desc"><?= cclang('list_all', ['Vaksinasi']); ?>  <i class="label bg-yellow"><?= $vaksinasi_counts; ?>  <?= cclang('items'); ?></i></h5>
                  </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($vaksinasis as $vaksinasi): ?>
                        <tr>
                           ...
                           <td><?php $dosis = setup_get_vaksin($vaksinasi->id); echo $dosis;   ?></td>
                           <td width="200">
                      ...
                      <?php endforeach; ?>
                      <?php if ($vaksinasi_counts == 0) :?>
                         <tr>
                           <td colspan="100">
                           Vaksinasi data is not available
                           </td>
                         </tr>
                      <?php endif; ?>
                     </tbody>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('vaksinasi');?>" title="<?= cclang('reset_filter'); ?>">
...
<script>
  $(document).ready(function(){
    ...
    $('#apply').click(function(){
      ...
      var bulk = $('#bulk');
      var serialize_bulk = $('#form_vaksinasi').serialize();
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/vaksinasi/delete?' + serialize_bulk;      
            }
          });
