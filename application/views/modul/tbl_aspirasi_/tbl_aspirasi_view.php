         ...
         <div class="box box-warning">
            ...
            <div class="form-group ">
             ...
             <div class="form-group ">
              ...
              <div class="col-sm-8">
                <select disabled class="form-control chosen chosen-select-deselect" name="jenis_aduan" id="jenis_aduan" data-placeholder="Select jenis_aduan">
                  <option value=""></option>
              ...
              <div class="col-sm-8">
                ...
                ?>
                <select disabled class="form-control chosen chosen-select-deselect" name="klasifikasi" id="klasifikasi" data-placeholder="Select klasifikasi Aduan">
                   <?php foreach ($a as $row) : ?>
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-8">
                ...
                ?>
                <select disabled class="form-control chosen chosen-select-deselect" name="proses" id="proses" data-placeholder="Select proses Aduan & Aspirasi">
                   <?php foreach ($a as $row) : ?>
