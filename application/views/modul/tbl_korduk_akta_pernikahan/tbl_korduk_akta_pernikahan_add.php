                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Adminduk Akta Pernikahan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_form_uuid" id="tbl_korduk_akta_pernikahan_form_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_form_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_form_name" id="tbl_korduk_akta_pernikahan_form_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_form_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ktp_suami_uuid" id="tbl_korduk_akta_pernikahan_ktp_suami_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ktp_suami_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ktp_suami_name" id="tbl_korduk_akta_pernikahan_ktp_suami_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ktp_suami_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ktp_istri_uuid" id="tbl_korduk_akta_pernikahan_ktp_istri_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ktp_istri_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ktp_istri_name" id="tbl_korduk_akta_pernikahan_ktp_istri_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ktp_istri_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_akta_kelahiran_suami_uuid" id="tbl_korduk_akta_pernikahan_akta_kelahiran_suami_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_akta_kelahiran_suami_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_akta_kelahiran_suami_name" id="tbl_korduk_akta_pernikahan_akta_kelahiran_suami_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_akta_kelahiran_suami_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_akta_kelahiran_istri_uuid" id="tbl_korduk_akta_pernikahan_akta_kelahiran_istri_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_akta_kelahiran_istri_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_akta_kelahiran_istri_name" id="tbl_korduk_akta_pernikahan_akta_kelahiran_istri_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_akta_kelahiran_istri_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ijazah_suami_uuid" id="tbl_korduk_akta_pernikahan_ijazah_suami_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ijazah_suami_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ijazah_suami_name" id="tbl_korduk_akta_pernikahan_ijazah_suami_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ijazah_suami_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ijazah_istri_uuid" id="tbl_korduk_akta_pernikahan_ijazah_istri_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ijazah_istri_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_ijazah_istri_name" id="tbl_korduk_akta_pernikahan_ijazah_istri_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_ijazah_istri_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_pas_foto_uuid" id="tbl_korduk_akta_pernikahan_pas_foto_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_pas_foto_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_pas_foto_name" id="tbl_korduk_akta_pernikahan_pas_foto_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_pas_foto_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_suket_pernikahan_uuid" id="tbl_korduk_akta_pernikahan_suket_pernikahan_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_suket_pernikahan_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_suket_pernikahan_name" id="tbl_korduk_akta_pernikahan_suket_pernikahan_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_suket_pernikahan_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_suket_desa_uuid" id="tbl_korduk_akta_pernikahan_suket_desa_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_suket_desa_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_suket_desa_name" id="tbl_korduk_akta_pernikahan_suket_desa_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_suket_desa_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_kk_uuid" id="tbl_korduk_akta_pernikahan_kk_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_kk_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_kk_name" id="tbl_korduk_akta_pernikahan_kk_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_kk_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_form2_uuid" id="tbl_korduk_akta_pernikahan_form2_uuid" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_form2_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_akta_pernikahan_form2_name" id="tbl_korduk_akta_pernikahan_form2_name" type="hidden" value="<?= set_value('tbl_korduk_akta_pernikahan_form2_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,  <b>Max size file</b>  500 kb.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/tbl_korduk_akta_pernikahan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_form = $('#tbl_korduk_akta_pernikahan_form_galery').find('li').attr('qq-file-id');
            var id_ktp_suami = $('#tbl_korduk_akta_pernikahan_ktp_suami_galery').find('li').attr('qq-file-id');
            var id_ktp_istri = $('#tbl_korduk_akta_pernikahan_ktp_istri_galery').find('li').attr('qq-file-id');
            var id_akta_kelahiran_suami = $('#tbl_korduk_akta_pernikahan_akta_kelahiran_suami_galery').find('li').attr('qq-file-id');
            var id_akta_kelahiran_istri = $('#tbl_korduk_akta_pernikahan_akta_kelahiran_istri_galery').find('li').attr('qq-file-id');
            var id_ijazah_suami = $('#tbl_korduk_akta_pernikahan_ijazah_suami_galery').find('li').attr('qq-file-id');
            var id_ijazah_istri = $('#tbl_korduk_akta_pernikahan_ijazah_istri_galery').find('li').attr('qq-file-id');
            var id_pas_foto = $('#tbl_korduk_akta_pernikahan_pas_foto_galery').find('li').attr('qq-file-id');
            var id_suket_pernikahan = $('#tbl_korduk_akta_pernikahan_suket_pernikahan_galery').find('li').attr('qq-file-id');
            var id_suket_desa = $('#tbl_korduk_akta_pernikahan_suket_desa_galery').find('li').attr('qq-file-id');
            var id_kk = $('#tbl_korduk_akta_pernikahan_kk_galery').find('li').attr('qq-file-id');
            var id_form2 = $('#tbl_korduk_akta_pernikahan_form2_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_form !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_form_galery').fineUploader('deleteFile', id_form);
                }
            if (typeof id_ktp_suami !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_ktp_suami_galery').fineUploader('deleteFile', id_ktp_suami);
                }
            if (typeof id_ktp_istri !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_ktp_istri_galery').fineUploader('deleteFile', id_ktp_istri);
                }
            if (typeof id_akta_kelahiran_suami !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_akta_kelahiran_suami_galery').fineUploader('deleteFile', id_akta_kelahiran_suami);
                }
            if (typeof id_akta_kelahiran_istri !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_akta_kelahiran_istri_galery').fineUploader('deleteFile', id_akta_kelahiran_istri);
                }
            if (typeof id_ijazah_suami !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_ijazah_suami_galery').fineUploader('deleteFile', id_ijazah_suami);
                }
            if (typeof id_ijazah_istri !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_ijazah_istri_galery').fineUploader('deleteFile', id_ijazah_istri);
                }
            if (typeof id_pas_foto !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_pas_foto_galery').fineUploader('deleteFile', id_pas_foto);
                }
            if (typeof id_suket_pernikahan !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_suket_pernikahan_galery').fineUploader('deleteFile', id_suket_pernikahan);
                }
            if (typeof id_suket_desa !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_suket_desa_galery').fineUploader('deleteFile', id_suket_desa);
                }
            if (typeof id_kk !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_kk_galery').fineUploader('deleteFile', id_kk);
                }
            if (typeof id_form2 !== 'undefined') {
                    $('#tbl_korduk_akta_pernikahan_form2_galery').fineUploader('deleteFile', id_form2);
                }
      ...
      }); /*end akta_kelahiran_suami galery*/
                     var params = {};
       params[csrf] = token;
      ...
      }); /*end akta_kelahiran_istri galery*/
                     var params = {};
       params[csrf] = token;
