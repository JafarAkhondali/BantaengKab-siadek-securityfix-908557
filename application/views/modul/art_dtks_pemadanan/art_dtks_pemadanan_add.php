                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Art Dtks Pemadanan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                         ...
                         <div class="col-lg-6">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="IDBDT" id="IDBDT" placeholder="IDBDT" value="<?= set_value('IDBDT'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="IDARTBDT" id="IDARTBDT" placeholder="IDARTBDT" value="<?= set_value('IDARTBDT'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="Hub_KRT" value="1"> Yes                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="Hub_KRT" value="2"> No                                    </label>
                                    </div>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="Hubkel" id="Hubkel" placeholder="Hubkel" value="<?= set_value('Hubkel'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="Ada_akta_nikah" id="Ada_akta_nikah" placeholder="Ada Akta Nikah" value="<?= set_value('Ada_akta_nikah'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="Ada_diKK" id="Ada_diKK" placeholder="Ada DiKK" value="<?= set_value('Ada_diKK'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="Ada_kartu_identitas" value="1"> Yes                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="Ada_kartu_identitas" value="2"> No                                    </label>
                                    </div>
                                    </select>
                                <div class="row-fluid clear-both">
                                <small class="info help-block">
                         ...
                         <div class="col-lg-6">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="Status[]" id="Status" data-placeholder="Select Status" multiple >
                                    ...
                                    <option value="2">NIK Tidak Sesuai</option>
                                    <option value="3">Sudah Meninggal</option>
                                    <option value="4">Wilayah Tidak Sesuai</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/art_dtks_pemadanan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
