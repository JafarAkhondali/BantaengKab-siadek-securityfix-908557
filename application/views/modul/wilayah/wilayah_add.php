                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Master Wilayah']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_wilayah', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="singkatan" id="singkatan" placeholder="Singkatan" value="<?= set_value('singkatan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kd_induk" id="kd_induk" placeholder="Kd Induk" value="<?= set_value('kd_induk'); ?>">
                                <small class="info help-block">
