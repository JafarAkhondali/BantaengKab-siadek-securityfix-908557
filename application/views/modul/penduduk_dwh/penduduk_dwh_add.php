                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['KEPENDUDUKAN DWH']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kd_kab" id="kd_kab" placeholder="Kd Kab" value="<?= set_value('kd_kab'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kd_kec" id="kd_kec" placeholder="Kd Kec" value="<?= set_value('kd_kec'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="status_hubungan" id="status_hubungan" placeholder="Status Hubungan" value="<?= set_value('status_hubungan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_krt" id="nama_krt" placeholder="Nama Krt" value="<?= set_value('nama_krt'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jenis_pekerjaan" id="jenis_pekerjaan" placeholder="Jenis Pekerjaan" value="<?= set_value('jenis_pekerjaan'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/penduduk_dwh/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
