                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username"><b>Suket Kematian</b></h3>
                            <h5 class="widget-user-desc"><?= cclang('new', ['Suket Kematian']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_suket_kematian', 
                            'class'   => 'form-horizontal', 
                            'id'      => 'form_suket_kematian', 
              ...
              <div class="col-sm-8">
               ...
               $username = get_user_data('username');
                ...
                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="waktu_kematian" class="col-sm-2 control-label">Waktu Kematian 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="waktu_kematian"  id="waktu_kematian">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                                                ...
                                                <div class="form-group ">
                            <label for="tempat_kematian" class="col-sm-2 control-label">Tempat Kematian 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tempat_kematian" id="tempat_kematian" placeholder="Tempat Kematian" value="<?= set_value('tempat_kematian'); ?>">
                                <small class="info help-block">
                                <b>Input Tempat Kematian</b> Max Length : 255.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        var form_suket_kematian = $('#form_suket_kematian');
        var data_post = form_suket_kematian.serializeArray();
        ...
        $.ajax({
          url: BASE_URL + '/suket_kematian/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
