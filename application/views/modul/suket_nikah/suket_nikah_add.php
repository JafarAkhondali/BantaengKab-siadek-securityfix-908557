                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Suket Menikah']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
              ...
              <div class="col-sm-8">
                ...
                <select class="form-control chosen chosen-select-deselect" name="suami" id="suami" data-placeholder="Select suami">
                  ...
                  <?php foreach ($a as $row) : ?>
                    ...
                    <option <?php if ($row->nik == $this->input->post('suami')) { ?>selected="selected" <?php } ?> value="<?= $row->nik ?>"><?= '[ ' . $row->nik . ' ] ' . $row->nama ?></option>
                  <?php endforeach; ?>
                </select>
                <small class="info help-block">
                </small>
              ...
              <div class="col-sm-8">
                ...
                <select class="form-control chosen chosen-select-deselect" name="istri" id="istri" data-placeholder="Select istri">
                  ...
                  <?php foreach ($a as $row) : ?>
                    ...
                    <option <?php if ($row->nik == $this->input->post('istri')) { ?>selected="selected" <?php } ?> value="<?= $row->nik ?>"><?= '[ ' . $row->nik . ' ] ' . $row->nama ?></option>
                  <?php endforeach; ?>
                </select>
                <small class="info help-block">
                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/suket_nikah/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
