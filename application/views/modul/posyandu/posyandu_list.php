            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc"><?= cclang('list_all', ['Posyandu']); ?>  <i class="label bg-yellow"><?= $posyandu_counts; ?>  <?= cclang('items'); ?></i></h5>
                  </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     <thead>
                        <tr class="">
                           ...
                           <th style="text-align:center" width="30%">Nama Posyandu</th>
                     ...
                     <?php foreach($posyandus as $posyandu): ?>
                      ...
                      <?php if ($posyandu_counts == 0) :?>
                         <tr>
                           <td colspan="100">
                           Posyandu data is not available
                           </td>
                         </tr>
                      <?php endif; ?>
                     </tbody>
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-3 padd-left-0 " >
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                           ...
                           <option <?= $this->input->get('f') == 'posyandu_nama' ? 'selected' :''; ?> value="posyandu_nama">Posyandu Nama</option>
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('posyandu');?>" title="<?= cclang('reset_filter'); ?>">
...
<script>
  $(document).ready(function(){
    ...
    $('#apply').click(function(){
      ...
      var bulk = $('#bulk');
      var serialize_bulk = $('#form_posyandu').serialize();
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/posyandu/delete?' + serialize_bulk;      
            }
          });
