                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pendidikan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="npsm" id="npsm" placeholder="Npsm" value="<?= set_value('npsm'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="Jml_Sync" id="Jml_Sync" placeholder="Jml Sync" value="<?= set_value('Jml_Sync'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pd" id="pd" placeholder="Pd" value="<?= set_value('pd'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">          
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="rombel" id="rombel" placeholder="Rombel" value="<?= set_value('rombel'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="guru" id="guru" placeholder="Guru" value="<?= set_value('guru'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ruang_perpus" id="ruang_perpus" placeholder="Ruang Perpus" value="<?= set_value('ruang_perpus'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ruang_lab" id="ruang_lab" placeholder="Ruang Lab" value="<?= set_value('ruang_lab'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/pendidikan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
