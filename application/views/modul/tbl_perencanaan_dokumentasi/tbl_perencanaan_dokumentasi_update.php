                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Dokumentasi Perencanaan</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('tbl_perencanaan_dokumentasi/edit_save/'.$this->uri->segment(3)), [
              ...
              <div class="col-sm-8">
                ...
                <small class="info help-block">
                  <b>Input Kd Wilayah</b> Max Length : 30.</small>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" value="<?= set_value('keterangan', $tbl_perencanaan_dokumentasi->keterangan); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="tbl_perencanaan_dokumentasi_file_galery_listed">
                                <?php foreach ((array) explode(',', $tbl_perencanaan_dokumentasi->file) as $idx => $filename): ?>
                                    <input type="hidden" class="listed_file_uuid" name="tbl_perencanaan_dokumentasi_file_uuid[<?= $idx ?>]" value="" /><input type="hidden" class="listed_file_name" name="tbl_perencanaan_dokumentasi_file_name[<?= $idx ?>]" value="<?= $filename; ?>" />
                                <?php endforeach; ?>
                                </div>
                                <small class="info help-block">
                                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_tbl_perencanaan_dokumentasi.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#tbl_perencanaan_dokumentasi_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#tbl_perencanaan_dokumentasi_file_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_perencanaan_dokumentasi/get_file_file/<?= $tbl_perencanaan_dokumentasi->id; ?>',
