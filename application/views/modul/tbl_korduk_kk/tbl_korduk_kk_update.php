                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Adminduk Kartu Keluarga</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('tbl_korduk_kk/edit_save/'.$this->uri->segment(3)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK" value="<?= set_value('nik', $tbl_korduk_kk->nik); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?= set_value('nama', $tbl_korduk_kk->nama); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" value="<?= set_value('alamat', $tbl_korduk_kk->alamat); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jenis_kelamin" id="jenis_kelamin" placeholder="Jenis Kelamin" value="<?= set_value('jenis_kelamin', $tbl_korduk_kk->jenis_kelamin); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_form_uuid" id="tbl_korduk_kk_form_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_form_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_form_name" id="tbl_korduk_kk_form_name" type="hidden" value="<?= set_value('tbl_korduk_kk_form_name', $tbl_korduk_kk->form); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_ktp1_uuid" id="tbl_korduk_kk_ktp1_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_ktp1_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_ktp1_name" id="tbl_korduk_kk_ktp1_name" type="hidden" value="<?= set_value('tbl_korduk_kk_ktp1_name', $tbl_korduk_kk->ktp1); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_ktp2_uuid" id="tbl_korduk_kk_ktp2_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_ktp2_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_ktp2_name" id="tbl_korduk_kk_ktp2_name" type="hidden" value="<?= set_value('tbl_korduk_kk_ktp2_name', $tbl_korduk_kk->ktp2); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,JPEG,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_surat_nikah_uuid" id="tbl_korduk_kk_surat_nikah_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_nikah_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_surat_nikah_name" id="tbl_korduk_kk_surat_nikah_name" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_nikah_name', $tbl_korduk_kk->surat_nikah); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,JPEG,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_surat_pindah_skwni_uuid" id="tbl_korduk_kk_surat_pindah_skwni_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_pindah_skwni_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_surat_pindah_skwni_name" id="tbl_korduk_kk_surat_pindah_skwni_name" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_pindah_skwni_name', $tbl_korduk_kk->surat_pindah_skwni); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,JPEG,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_surat_pindah_alamat_uuid" id="tbl_korduk_kk_surat_pindah_alamat_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_pindah_alamat_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_surat_pindah_alamat_name" id="tbl_korduk_kk_surat_pindah_alamat_name" type="hidden" value="<?= set_value('tbl_korduk_kk_surat_pindah_alamat_name', $tbl_korduk_kk->surat_pindah_alamat); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,JPEG,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="tbl_korduk_kk_suket_hilang_uuid" id="tbl_korduk_kk_suket_hilang_uuid" type="hidden" value="<?= set_value('tbl_korduk_kk_suket_hilang_uuid'); ?>">
                                <input class="data_file" name="tbl_korduk_kk_suket_hilang_name" id="tbl_korduk_kk_suket_hilang_name" type="hidden" value="<?= set_value('tbl_korduk_kk_suket_hilang_name', $tbl_korduk_kk->suket_hilang); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,PNG,PDF,JPEG,  <b>Max size file</b>  300 kb.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_tbl_korduk_kk.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#tbl_korduk_kk_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#tbl_korduk_kk_form_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_form_file/<?= $tbl_korduk_kk->id; ?>',
       ...
       $('#tbl_korduk_kk_ktp1_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_ktp1_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#tbl_korduk_kk_ktp2_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_ktp2_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#tbl_korduk_kk_surat_nikah_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_surat_nikah_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#tbl_korduk_kk_surat_pindah_skwni_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_surat_pindah_skwni_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#tbl_korduk_kk_surat_pindah_alamat_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_surat_pindah_alamat_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#tbl_korduk_kk_suket_hilang_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'tbl_korduk_kk/get_suket_hilang_file/<?= $tbl_korduk_kk->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
