...
$pdf->SetTitle('Suket Belum Menikah');
...
foreach ($cetak as $row) {
  ...
  $html = '<h4 align="center"><U>SURAT KETERANGAN BELUM MENIKAH</U> <br> Nomor: ' . $row['no'] . '</h4>
          ...
          <p>Benar yang namanya tersebut diatas adalah Warga di ' . strtolower($klasifikasik) . ' ' . $desa . ' Kecamatan ' . $camat . ' Kabupaten Bantaeng <b>Yang Belum Pernah Menikah</b> .<br><br>Demikian surat keterangan ini diberikan untuk dipergunakan sebagaimana mestinya.<br><br>
          </p>
         <table>
...
$pdf->Output('Surat Keterangan Belum Menikah.pdf', 'I');
?>
