...
$istris = db_get_all_data('penduduk_real', "nik = $nik_is");
foreach ($istris as $row) {
  $nama_istri = $row->nama;
  ...
  $agama_istri = setup_get_data('setup_agama',$row->agama);
}

$pekerjaan = setup_get_data('setup_pekerjaan', $jen_peker);

$pekerjaan_istri = setup_get_data('setup_pekerjaan', $jen_peker_istri);
